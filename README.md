    ...
    <div class="container">
      ...
      <h1 style="font-size:30px; color:black;
           text-shadow: 0 0 10px #00aaff,
            ...
            color: white;">
  NGUYỄN HUỲNH ĐĂNG THƯ 
</h1>
         <div style="background-color: #9387AB; padding: 10px;"> 
       <p style="text-align:center;text-decorating: none; color: white; padding: 0 10px;">Mắt gấu trúc</p>
         </div>
<style>
        /* Tiêu đề */
.title {
...
.container {
    ...
    <div class="container">
        <div class="card">
            <img src="ảnh1.jpg" class="avatar">
        </div>
      <div class="card">
            <img src="ảnh2.jpg" class="avatar">
      </div>
      <div class="card">
            <img src="ảnh3.jpg" class="avatar">
      </div>
      <div class="card">
            <img src="ảnh4.jpg" class="avatar">
         </div>
      </div>
         </body>
